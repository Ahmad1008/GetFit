        ...
        child: Column(
          children: <Widget>[
            Container(
              ...
              decoration: new BoxDecoration(color: Color(0xFF232441)),
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("       GetFit BMI Calculator",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 25.0),),
                  Text("                  For Calculating your Body Fat",style: TextStyle(color: Colors.white,fontSize: 15.0),),
                  new Row(children: <Widget>[
                            Text(' '),
                            Expanded(child: Text(''))
                            ], crossAxisAlignment: CrossAxisAlignment.start),
