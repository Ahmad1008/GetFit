...
import 'package:flutter/material.dart'
    show Align, Alignment, AssetImage, Border, BorderRadius, BorderSide, BoxDecoration, BoxFit, BuildContext, Center, Color, Colors, Column, Container, CrossAxisAlignment, DecorationImage, EdgeInsets, FlatButton, FontWeight, InputDecoration, LinearGradient, MaterialButton, MaterialPageRoute, MediaQuery, Navigator, Padding, RichText, Scaffold, SingleChildScrollView, SizedBox, Spacer, Stack,  Text, TextField,  TextSpan, TextStyle, UnderlineInputBorder, Widget;
